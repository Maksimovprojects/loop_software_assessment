...
class DashboardPage:
    ...
    def __init__(self, page: Page):
        ...
        # ── Board columns ─────────────────────────────────────────────────────
        self.column_headers = page.locator("h2, h3")
        self.column_container = page.locator("div").filter(
    ...
    def get_column(self, column_name: str):
        ...
        return self.column_container.filter(has=self.column_headers.filter(has_text=column_name)).first
    ...
    def verify_task_in_column(self, task_name: str, column_name: str):
        ...
        task_card = column.get_by_text(task_name, exact=True)
